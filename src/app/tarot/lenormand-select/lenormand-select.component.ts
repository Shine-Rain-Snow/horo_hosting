...
@Component({
  selector: 'app-lenormand-select',
  templateUrl: './lenormand-select.component.html',
  styleUrls: ['./lenormand-select.component.scss']
})
export class LenormandSelectComponent implements OnInit {
