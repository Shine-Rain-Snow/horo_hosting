...
export class ShowCardsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.deck_mode == 1) {
      ...
      this.deck_one1 = this.riderCard_txt[threeCardNums[1]-1].detail1;
      this.deck_two1 = this.riderCard_txt[threeCardNums[2]-1].detail1;
      this.deck_three1 = this.riderCard_txt[threeCardNums[3]-1].detail1;
      this.deck_one2 = this.riderCard_txt[threeCardNums[1]-1].detail2;
      this.deck_two2 = this.riderCard_txt[threeCardNums[2]-1].detail2;
      this.deck_three2 = this.riderCard_txt[threeCardNums[3]-1].detail2;
    }
    ...
    if(this.deck_mode == 2 ) {
      ...
      this.deck_one1 = this.hermeticCard_txt[threeCardNums[1]-1].detail1;
      this.deck_two1 = this.hermeticCard_txt[threeCardNums[2]-1].detail1;
      this.deck_three1 = this.hermeticCard_txt[threeCardNums[3]-1].detail1;
      this.deck_one2 = this.hermeticCard_txt[threeCardNums[1]-1].detail2;
      this.deck_two2 = this.hermeticCard_txt[threeCardNums[2]-1].detail2;
      this.deck_three2 = this.hermeticCard_txt[threeCardNums[3]-1].detail2;
    }
    ...
    $(".three-title").hover(function() {
      $(".three-title").css({'color': self.getFourColor()});
    }, function() {
      $(".three-title").css({'color': '#5A3594'});
    });
    $(".three-back-reading").hover(function() {
      $(".three-back-reading").css({'color': self.getFourColor()});
    }, function() {
      $(".three-back-reading").css({'color': '#5A3594'});
    });
  }
  ...
  ngAfterViewInit() {
    if(this.deck_mode == 3) {
      ...
      let twoArr = [];
      let threeArr = [];
      oneArr = this.deck_one2.split(".");
      twoArr = this.deck_two2.split(".");
      threeArr = this.deck_three2.split(".");
      //console.log(strArr);
      oneArr.forEach((element, k) => {
        //console.log("num"+k);
        if(k % 2 != 0) {
          $(".one-arr").append("<div>"+oneArr[k-1]+"."+oneArr[k]+"."+"</div>");
        } 
        k++;
      });

      twoArr.forEach((element, k) => {
        //console.log("num"+k);
        if(k % 2 != 0) {
          $(".two-arr").append("<div>"+twoArr[k-1]+"."+twoArr[k]+"."+"</div>");
        } 
        k++;
      });

      threeArr.forEach((element, k) => {
        //console.log("num"+k);
        if(k % 2 != 0) {
          $(".three-arr").append("<div>"+threeArr[k-1]+"."+threeArr[k]+"."+"</div>");
        } 
        k++;
      });
    }
