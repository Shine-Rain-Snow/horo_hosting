...
export class AstInnerComponent implements OnInit {
  ...
  sunsign_description = {
      ...
      "pisces_love": `This is a very important year for relationship. You will need a change! The fear of commitment is likely to reduce this year. You will still feel confuse regarding your current relationship yet you will know that you need to take action. Many of you will walk away from a relationship that suffered countless breakups since last few years others will meet someone new and plan to settle down! Your best partners this year are Pisces, cancer and Capricorn!`,
